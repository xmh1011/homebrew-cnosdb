...
class Cnosdb < Formula
  ...
  version "1.0.2"
  url "https://github.com/cnosdb/cnosdb/releases/download/v1.0.2/cnosdb-1.0.2_darwin_amd64.tar.gz"
  ...
  test do
    ...
    # software. Run the test with `brew test cnosdb`. Options passed
